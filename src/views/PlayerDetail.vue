  ...
  <div v-infinite-scroll="loadMore"
    ...
    <div class="player-detail" v-if="playerDetail !== null">
      ...
      <div class="player-detail-mvp">
        ...
        <div class="player-detail-mvp-item">
          <img src="../assets/images/mvpicon.png" alt="">
          <p>MVP: {{ totalMvps }}</p>
        </div>
        <div class="player-detail-mvp-item">
      ...
      <div class="player-detail-combats">
        <ul v-if="combatList.length > 0">
          <router-link tag="li" v-for="(combat,index) in combatList" :key="index" :to="{name: 'combatDetail', params: {gameid: combat.game_id}}">
            <div class="icon">
            ...
            <div class="arrow-right">
              <img src="../assets/images/arrow_blue.png" alt="">
            </div>
          </router-link>
...
.player-detail {
  &-header {
    height: 150px;
    background: url('../assets/images/playerdetailbg.png');
    &-icon {
      text-align: center;
      padding-top: 12px;
      color: #fff;
