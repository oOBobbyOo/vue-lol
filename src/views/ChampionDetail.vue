      ...
      <div class="champion-detail-tabinfo">
        <div class="skills" v-if="selected == 1">
          ...
          <div class="skills-list">
            <mu-flexbox class="mt8" orient="horizontal" v-for="(skill,index) in skills" :key="skill">
              <mu-flexbox-item order="0" class="flex-demo" grow=1>
                <div class="skills-list-item_img">
                  <img :src="skill.imgurl" alt="">
                </div>
              </mu-flexbox-item>
              <mu-flexbox-item order="1" class="flex-demo" grow=4>
        ...
        <div class="skills" v-if="selected == 2">
